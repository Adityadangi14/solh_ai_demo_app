      ...
      "children": [
        {
          ...
          "child": {
            "type": "image",
            "src": "https://solhapp-live.s3.amazonaws.com/solhApp/homepage-banner/1717064120134.jpg",  // Audio thumbnail
            "imageType": "network",
            "width": 60.0,
            "height": 60.0,
            "fit": "cover"
            ...
            "children": [
              {
                ...
                "child": {
                  "type": "text",
                  "maxLines": 2,
                  "data": "Find calm with this audio-Relax and Unwind",  // Audio title
                  "style": {
                    "fontSize": 14.0,
                    "fontWeight": "w700",
                    "color": "#222222"
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: Center(child: ListView.builder(itemCount: 100,itemBuilder: (context, index) {
      return Stac.fromJson(jso,context);
    },)),);
  }
}
